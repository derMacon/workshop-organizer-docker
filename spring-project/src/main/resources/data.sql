...
values (0, 'admin_fst', 'admin_sur', 'admin@mail.com', 0)
ON CONFLICT DO NOTHING;

insert into app_user (user_id, username, password, role)
values (1, 'user1', '$2a$10$FBJBMqWqoPXc2aEKeOZoaechKfjahVlrNi6wFQwoq1KhLnqxCzqy2', 'ROLE_USER')
ON CONFLICT DO NOTHING;

insert into person (person_id, firstname, surname, email, user_id)
values (1, 'user_fst', 'user_sur', 'admin@mail.com', 1)
ON CONFLICT DO NOTHING;
...
values (0, 'announcement1', 'Please make sure to bring your own baking supplies. In the studio
